...
interface IFileProps extends DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement> {
  file: any
  id?: string
...
const File = ({file, disabled = false, id = '', deleteFile}: IFileProps) => {
  ...
  return (
    <div className={styles.file}>
      ...
      {!disabled && <DeleteIcon onClick={() => deleteFile(id)} className={styles.deleteIcon}/>}
    </div>
  );
}
